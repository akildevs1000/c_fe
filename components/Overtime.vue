        ...
        <v-card-text>
          <v-container>
            <v-row v-for="(item, index) in items" :key="index">
              ...
              <v-col cols="5">
                <v-text-field type="number" v-model="item.no_of_hours" label="No. of hours"></v-text-field>

                <span v-if="errors && errors.no_of_hours" class="text-danger mt-2">{{
                  errors.no_of_hours[0]
                }}</span>
              </v-col>

              <v-col cols="5">
                <v-text-field type="number" v-model="item.no_of_days" label="No. of days"></v-text-field>

                <span v-if="errors && errors.no_of_days" class="text-danger mt-2">{{
                  errors.no_of_days[0]
                }}</span>
              </v-col>
            </v-row>
...
export default {
  ...
  methods: {
    ...
    add() {
      this.items.push({ title: "", amount: "", no_of_hours: "", no_of_days: "", });
    },
    removeItem(index) {
      ...
      this.$axios
        ...
        .then(({ data }) => {
          ...
          if (!data.status) {
            ...
            this.items = [{ title: "", amount: "", no_of_hours: "", no_of_days: "", }];
