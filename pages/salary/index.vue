                  ...
                  <v-container>
                    <v-row>
                      ...
                      <v-col cols="12" class="mb-2">
                        ...
                        <span v-if="errors && errors.employee_id" class="error--text">{{errors.employee_id[0]}}</span>
                        <v-autocomplete
                        ...
                        <span v-if="errors && errors.salary_type_id" class="error--text">{{errors.salary_type_id[0]}}</span>

                        <v-text-field
                          v-model="editedItem.amount"
                          label="Amount"
                        ></v-text-field>
                        <span v-if="errors && errors.amount" class="error--text">{{errors.amount[0]}}</span>
                      </v-col>
                    </v-row>
                  </v-container>
                </v-card-text>
