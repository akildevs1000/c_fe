        ...
        <v-card-text>
          <v-row>
            ...
            <v-col cols="12" md="6">
              ...
              >
              <!-- <v-menu
                ref="grace_time_in_menu_ref"
                v-model="grace_time_in_menu"
                :close-on-content-click="false"
                :nudge-right="40"
                :return-value.sync="payload.grace_time_in"
                transition="scale-transition"
                offset-y
                max-width="290px"
                min-width="290px"
              >
                ...
                >
                  ...
                  <v-btn
                    x-small
                    color="primary"
                    @click="grace_time_in_menu = false"
                  >
                    Cancel
                  </v-btn>
                  <v-btn
                    ...
                    color="primary"
                    @click="
                      $refs.grace_time_in_menu_ref.save(payload.grace_time_in)
                    "
                  >
                    OK
                  </v-btn>
            ...
            <v-col cols="12" md="6">
              ...
              >
              <!-- <v-menu
                ref="grace_time_out_menu_ref"
                v-model="grace_time_out_menu"
                :close-on-content-click="false"
                :nudge-right="40"
                :return-value.sync="payload.grace_time_out"
                transition="scale-transition"
                offset-y
                max-width="290px"
                min-width="290px"
              >
                ...
                >
                  ...
                  <v-btn
                    x-small
                    color="primary"
                    @click="grace_time_out_menu = false"
                  >
                    Cancel
                  </v-btn>
                  <v-btn
                    ...
                    color="primary"
                    @click="
                      $refs.grace_time_out_menu_ref.save(payload.grace_time_out)
                    "
                  >
                    OK
                  </v-btn>
      ...
      this.$axios
        ...
        .then(({ data }) => {
          ...
          if (!data.status) {
            ...
            this.snackbar = true;
            this.response = "Schedule added successfully";
